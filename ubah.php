...
<body background="img/bg/bck.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">UBSI</a>
    ...
    <div class="row bg-dark text-white text-center">
        <div class="col my-2" id="about">
            <h4 class="fw-bold text-uppercase">Web Programming</h4>
            <br>
            <p>
                Pembuat Kelompok 4 :
                <br>
                1. <span style="color: white;">FATTAH NURIZHA HERLAMBANG (17220262)</span>
                2. <span style="color: white;">MUHAMMAD FAQIH SAIFUL ISLAM (17221215)</span>
                3. <span style="color: white;">TAUFIK ALMUNAWAR (17220403)</span>
            </p>
        </div>
    </div>
</div>
